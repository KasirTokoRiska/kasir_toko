                    ...
                    @foreach ($kategoris as $key => $kategori)
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <button type="button" data-toggle="modal" data-target="#modalDelete" data-url="{{ route('kategori.destroy', ['kategori' => $kategori->id]) }}" class="btn btn-xs text-danger p-0 tn-delete">
