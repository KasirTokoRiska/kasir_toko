...
@section('content')
    ...
    <div class="card card-orange card-outline">
        <div class="card-header form-inline">
            ...
            <form action="{{ url('your-search-url') }}" method="get" class="ml-auto">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $user->nama }}</td> <!-- Change $users to $user -->
                        <td>{{ $user->username }}</td> <!-- Change $users to $user -->
                        <td>{{ $user->role}}</td> <!-- Change $users to $user -->
